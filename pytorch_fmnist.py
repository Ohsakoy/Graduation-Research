...
np.savez('F_MNIST_model_1-10/model_result', train_loss_result=TrainLoss,
        train_acc_result=TrainAccuracy, test_loss_result=TestLoss, test_acc_result=TestAccuracy)

...
for i in range(10):
    ...
    if args.dataset == 'mnist':
        ...
        test_images = torch.load(
            '{d}_data/test_images.pt'.format(d=args.dataset))
        test_labels = torch.load(
            '{d}_data/test_labels.pt'.format(d=args.dataset))
    ...
    for epoch in range(args.start_epoch, args.epoch):
        ...
        if args.method == 'CE' or args.method == 'CDR':
        ...
        print("outlier_detection_accuracy: %.4f" %
              (outlier_detection_accuracy))
    ...
    elif args.method == 'Trimming' or args.method == 'Trimming_minibatch' or args.method == 'Trimming_change':
